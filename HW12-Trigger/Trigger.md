...
Fix: Для решения проблемы Insert в sales необходимо добавить уникальный индекс на новую таблицу `CREATE UNIQUE INDEX good_sum_mart_unq ON good_sum_mart (good_name);`;